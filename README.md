...
[![Maven Central](https://img.shields.io/maven-central/v/io.github.easy4j/calibre-invoker-spring-boot-starter)](https://github.com/easy-4-java/calibre-invoker-spring-boot-starter)
...
> **Artifact ID**：`calibre-invoker-spring-boot-starter`<br>
> **License**：Apache License 2.0<br>

## 1. Positioning

**calibre-invoker-spring-boot-starter** is a Spring Boot starter that integrates **calibre-invoker** for applications using calibre-invoker. It provides auto-configuration, property binding, and ready-to-use beans so that applications can consume calibre-invoker capabilities with minimal setup.

| Dimension | Description |
|---|---|
| Type | Spring Boot Starter |
| Consumers | Spring Boot applications using calibre-invoker |
| Core Capabilities | auto-configuration, property binding, ready-to-use beans for calibre-invoker |
| JDK | `17` |
| Coordinates | `io.github.easy4j:calibre-invoker-spring-boot-starter:3.5.x.20260527-SNAPSHOT` |
| Config Prefix | `calibre.invoker` |

## 2. Core Capabilities

| Capability | Status | Description |
|---|:---:|---|
| Auto-configuration | ✅ Stable | Registers calibre-invoker beans automatically |
| Property Binding | ✅ Stable | Binds `calibre.invoker.*` to `CalibreInvokerProperties` |
...
|---|---|---|:---:|---|:---:|
| `calibre.invoker.enabled` | boolean | `true` | No | Enable the starter | No |
...
```bash
mvn clean verify
mvn -pl calibre-invoker-spring-boot-starter -am test
```
...
|---|---|---|
| Bean not created | Check auto-configuration report | Verify `calibre.invoker.enabled=true` and classpath |
...
[Back to top](#readme-top) · [Issues](https://github.com/easy-4-java/calibre-invoker-spring-boot-starter/issues) · [Repository](https://github.com/easy-4-java/calibre-invoker-spring-boot-starter)
